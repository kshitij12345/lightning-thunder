...
def _single_tensor_adam(
    ...
    *,
    ...
    for i, param in enumerate(params):
        ...
        exp_avg_sq.copy_((exp_avg_sq * beta2) + (1 - beta2) * grad * grad)
        ...
        param.copy_(param + (-step_size) * exp_avg / denom)
...
optim_func = torch.compile(_single_tensor_adam, fullgraph=True)
